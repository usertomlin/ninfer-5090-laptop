"""Structural and representative-source verification for a Qwen3.5-4B `.ninfer` artifact."""
...
class VerificationError(ValueError):
    """The artifact does not match the registered Qwen3.5-4B target contract."""
