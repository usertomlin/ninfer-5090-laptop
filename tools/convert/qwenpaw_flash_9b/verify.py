"""Structural and representative-source verification for a QwenPaw-Flash-9B artifact."""
...
class VerificationError(ValueError):
    """The artifact does not match the registered target contract."""
...
def verify_direct_tensors(
    ...
    for object_name in DIRECT_PROBE_OBJECTS:
        ...
        expected = recipe.materialize_recipe(
            recipe.SOURCE_RECIPES_BY_NAME[object_name],
            source_reader,
        )
