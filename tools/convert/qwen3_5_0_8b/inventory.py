"""Persistent-object contract for the Qwen3.5-0.8B target.
...
def _build_text_core_specs() -> tuple[TensorSpec, ...]:
    ...
    for layer in range(24):
        ...
        if layer in FULL_ATTENTION_LAYERS:
            specs.extend(
                (
                    _tensor(prefix + "attention/query_key", (2560, HIDDEN), Q4),
                    _tensor(prefix + "attention/gate_value", (2560, HIDDEN), Q5),
            ...
            specs.extend(
                (
                    ...
                    _tensor(prefix + "gdn/a_projection", (16, HIDDEN), BF16),
                    _tensor(prefix + "gdn/b_projection", (16, HIDDEN), BF16),
        ...
        specs.extend(
            (
                ...
                _tensor(prefix + "mlp/gate_up", (7168, HIDDEN), Q4),
                _tensor(prefix + "mlp/down", (HIDDEN, 3584), Q5),
            )
        )
...
def _build_mtp_specs() -> tuple[TensorSpec, ...]:
    return (
        ...
        _tensor("mtp/layer/mlp/gate_up", (7168, HIDDEN), W8),
        _tensor("mtp/layer/mlp/down", (HIDDEN, 3584), W8),
