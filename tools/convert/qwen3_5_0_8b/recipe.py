"""Hugging Face source recipe for the complete Qwen3.5-0.8B inventory.
...
Qwen3.5-0.8B vision tower is also checkpoint-specific (12 layers, width 768), so
            ...
            recipes.extend(
                (
                    ...
                    TensorRecipe(
                        ...
                        Cast(_source(source_prefix + "linear_attn.dt_bias", (16,)), inventory.FP32),
                    ),
                    TensorRecipe(
                    ...
                    TensorRecipe(
                        ...
                        _source(source_prefix + "linear_attn.in_proj_a.weight", (16, HIDDEN)),
                    ),
                    TensorRecipe(
                        object_prefix + "gdn/b_projection",
                        _source(source_prefix + "linear_attn.in_proj_b.weight", (16, HIDDEN)),
                    ),
                    TensorRecipe(
...
def _build_mtp_recipes() -> tuple[TensorRecipe, ...]:
    ...
    q_proj = source_prefix + "self_attn.q_proj.weight"
    return (
        TensorRecipe("mtp/input_projection", _source("mtp.fc.weight", (HIDDEN, 2048))),
        TensorRecipe(
            "mtp/embedding_norm",
