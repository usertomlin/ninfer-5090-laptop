"""Hugging Face source recipe for the complete Qwen3.5-2B inventory.
...
Qwen3.5-2B vision tower is also checkpoint-specific (24 layers, width 1024), so
...
def _build_mtp_recipes() -> tuple[TensorRecipe, ...]:
    ...
    q_proj = source_prefix + "self_attn.q_proj.weight"
    return (
        TensorRecipe("mtp/input_projection", _source("mtp.fc.weight", (HIDDEN, 4096))),
        TensorRecipe(
            "mtp/embedding_norm",
