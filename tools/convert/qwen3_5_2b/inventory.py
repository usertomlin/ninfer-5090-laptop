"""Persistent-object contract for the Qwen3.5-2B target.
    ...
    for layer in range(24):
        ...
        specs.extend(
            (
                ...
                _tensor(prefix + "mlp/gate_up", (12288, HIDDEN), Q4),
                _tensor(prefix + "mlp/down", (HIDDEN, 6144), Q5),
            )
        )
...
def _build_mtp_specs() -> tuple[TensorSpec, ...]:
    return (
        _tensor("mtp/input_projection", (HIDDEN, 4096), W8),
        ...
        _tensor("mtp/layer/mlp/gate_up", (12288, HIDDEN), W8),
        _tensor("mtp/layer/mlp/down", (HIDDEN, 6144), W8),
