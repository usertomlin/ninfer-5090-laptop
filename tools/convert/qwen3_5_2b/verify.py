"""Structural and representative-source verification for a Qwen3.5-2B `.ninfer` artifact."""
...
class VerificationError(ValueError):
    """The artifact does not match the registered Qwen3.5-2B target contract."""
