...
// Qwen3.6-27B/35B-A3B, 64 groups (K=4096) for Qwen3.5-9B, 32 groups (K=2048) for
// Qwen3.5-2B, and 16 groups (K=1024) for Qwen3.5-0.8B. The kernel ignores the runtime
// k in the static-ownership branch, so each K must use its own schedule.
...
using Q4GemvR1W8DirectK32Schedule =
    Q4RowSplitGemvSchedule<1, 8, 16, 1, Q4GemvActivationAccess::Direct,
                           ...
                           Q4GemvCodeTransfer::SyncVector16, Q4GemvScaleAccess::Scalar16Shuffle,
                           Cache::ca, 32, 1>;
using Q4GemvR1W8DirectK16Schedule =
    Q4RowSplitGemvSchedule<1, 8, 16, 1, Q4GemvActivationAccess::Direct,
                           Q4GemvLaneMapping::PackedByte2, Q4GemvDecodeMode::ScalarInteger,
                           Q4GemvCodeTransfer::SyncVector16, Q4GemvScaleAccess::Scalar16Shuffle,
                           Cache::ca, 16, 1>;
