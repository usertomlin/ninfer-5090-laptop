...
#define NINFER_QWEN36_VARIANT    ::ninfer::targets::qwen3_5_0_8b::detail::Variant
#define NINFER_QWEN36_RUNTIME_NS qwen3_5_0_8b_runtime
...
void Variant::mtp_kv_projection(const Tensor& hidden, const MtpAttentionProjectionWeights& weights,
    ...
    // The 0.8B packed MTP projection stores key and value as two 512-row slices of a
    // [5120, hidden] weight, separated by the 2048-row gate slice, so they are not adjacent and
    // cannot share a paired launch.
...
std::size_t Variant::attention_projection_workspace_capacity_bytes(WeightsProfile weights_profile,
    ...
    throw std::logic_error("invalid 0.8B weights profile");
}
