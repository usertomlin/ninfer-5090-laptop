...
private:
    ...
    friend struct qwen3_5_4b::Package;
};
...
struct Package {
    static constexpr std::string_view model_id   = "qwen3.5-4b";
    static constexpr std::string_view target_key = "qwen3_5_4b";
