#include "targets/qwen3_5_4b/impl/variant.h"
...
#define NINFER_QWEN36_VARIANT    ::ninfer::targets::qwen3_5_4b::detail::Variant
#define NINFER_QWEN36_RUNTIME_NS qwen3_5_4b_runtime
...
std::size_t Variant::attention_projection_workspace_capacity_bytes(WeightsProfile weights_profile,
    ...
    throw std::logic_error("invalid 4B weights profile");
}
...
std::size_t Variant::post_mixer_workspace_capacity_bytes(WeightsProfile weights_profile,
    ...
    case WeightsProfile::GroupwiseInt:
        break;
    default:
        throw std::invalid_argument("qwen3_5_4b: invalid weights profile");
    }
