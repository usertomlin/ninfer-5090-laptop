...
struct BindingPlan {
    ...
    qwen3_6::VisionBackbonePlanT<VisionConfig> vision_backbone;
    qwen3_6::VisionMergerInputPlanT<VisionConfig> vision_merger_input;
    artifact::ObjectHandle vision_merger_fc2;
    artifact::ObjectHandle vision_merger_fc2_bias;
    qwen3_6::VisionMergerNormPlanT<VisionConfig> vision_merger_norm;
};
...
using RuntimeModelView =
    qwen3_6::ModelView<FullAttentionProjectionPayload, GdnProjectionPayload, DensePostMixerPayload,
                       ...
                       kFullAttentionLayers, kGdnLayers, qwen3_6::VisionWeightsT<VisionConfig>>;
